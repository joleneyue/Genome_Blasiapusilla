...
#Input files created with haltools halStats on alignment file
      ...
      names(cov) <- c("helsinkihelsinki","cornellhelsinki","helsinkicornell","cornellcornell")
      ...
      cov <- transform(cov, helsinkihelsinki = as.numeric(helsinkihelsinki), cornellhelsinki = as.numeric(cornellhelsinki), helsinkicornell = as.numeric(helsinkicornell), cornellcornell = as.numeric(cornellcornell))
